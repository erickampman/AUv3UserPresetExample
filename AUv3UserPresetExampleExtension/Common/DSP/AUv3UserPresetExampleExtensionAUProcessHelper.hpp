//
//  AUv3UserPresetExampleExtensionAUProcessHelper.hpp
...
#include <vector>
#include "AUv3UserPresetExampleExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(AUv3UserPresetExampleExtensionDSPKernel& kernel, UInt32 outputChannelCount)
    : mKernel{kernel},
...
private:
    AUv3UserPresetExampleExtensionDSPKernel& mKernel;
