//
//  AUv3UserPresetExampleExtensionDSPKernel.hpp
...
#import "AUv3UserPresetExampleExtension-Swift.h"
#import "AUv3UserPresetExampleExtensionParameterAddresses.h"

/*
 AUv3UserPresetExampleExtensionDSPKernel
 As a non-ObjC class, this is safe to use from render thread.
 */
class AUv3UserPresetExampleExtensionDSPKernel {
public:
    ...
    // Add a case for each parameter in AUv3UserPresetExampleExtensionParameterAddresses.h
    void setParameter(AUParameterAddress address, AUValue value) {
        switch (address) {
            case AUv3UserPresetExampleExtensionParameterAddress::gain:
                mGain = value;
                break;
        }
    }
    ...
    void handleMIDIEventList(AUEventSampleTime now, AUMIDIEventList const* midiEvent) {
        auto visitor = [] (void* context, MIDITimeStamp timeStamp, MIDIUniversalMessage message) {
            auto thisObject = static_cast<AUv3UserPresetExampleExtensionDSPKernel *>(context);
